...
A client wanted an application to store, track, and add employees with their respective departments, roles, and salaries. This is an interface that allows the user to access the database that stores their employee information.
